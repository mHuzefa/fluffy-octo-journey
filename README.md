# medicom ECommerce Website

![medicom](/template/images/medicom.jpg)
...
- 👉 Heroku : [https://newmedicom-final.herokuapp.com](https://newmedicom-final.herokuapp.com)
- 👉 AWS : [https://medicom.webacademy.pro](https://medicom.webacademy.pro)
...
```
$ git clone git@github.com:basir/medicom.git
$ cd medicom
```
...
- Local MongoDB
  ...
  - Set MONGODB_URL=mongodb://localhost/medicom
- Atlas Cloud MongoDB
...
- Q/A: https://webacademy.pro/medicom
...
45. Publish To Heroku
    ...
    4. heroku login
    5. heroku apps:create <yourname>medicom
